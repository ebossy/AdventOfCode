...
width = 71
height = 71
#1024 geht  2860geht nicht
#2855 geht  2856geht nicht
#try until it doesnt work with binary search
first_x_byte = 2856
...
print(str(falling_byte[first_x_byte-1][1])+","+str(falling_byte[first_x_byte-1][0]))
